...
const AllAdmin = observer(() => {
  ...
  // טוען את כל המנהלים כאשר הקומפוננטה נטענת
  useEffect(() => {
    adminStore.fetchAdmins();
  }, []);

  // פונקציית עריכה: מנווטת לעמוד עריכת המנהל לפי ID
  const handleEdit = (id) => {
    navigate(`/admin/edit-admin/${id}`);
  };

  // פונקציית מחיקה: מוחקת מנהל ומביאה מחדש את הרשימה
